...
void setup() 
{
  ...
  delay(2000);
      FastLED.addLeds<APA102, 4, 5, RGB, DATA_RATE_MHZ(5)>(leds, NUM_LEDS);
}
...
void loop(){
  ...
  if (lr == 3){
    lr--;
    for (int i=0; i < sizeof(bottom_left_one);i++){
      leds[bottom_left_one[i]] = CRGB::Grey;
      FastLED.show();
      delay(100);
    for (int i=0; i < sizeof(middle_paddle);i++){
      leds[middle_paddle[i]] = CRGB::Black;
      FastLED.show();
      delay(100);}
      }
  }
    ...
    byte countl2 = 0;
    lr--;
    for (int i=0; i < sizeof(bottom_left_two);i++){
      leds[bottom_left_two[i]] = CRGB::Grey;
      FastLED.show();
      delay(100);
      countl2++;
    for (int i=0; i < sizeof(bottom_left_one);i++){
      leds[bottom_left_one[i]] = CRGB::Black;
      FastLED.show();
      delay(100);}
        }
  }
     ...
     byte countl3 = 0;
     lr--;
     for (int i=0; i < sizeof(bottom_left_three);i++){
      leds[bottom_left_three[i]] = CRGB::Grey;
      FastLED.show();
      delay(100);}
     for (int i=0; i < sizeof(bottom_left_two);i++){
       leds[bottom_left_two[i]] = CRGB::Black;
       FastLED.show();
       delay(100);}
     }
     else if (lr == 0){
       ...
       for (int i=0; i < sizeof(bottom_left_two);i++){
         ...
         delay(100);}
       for (int i=0; i < sizeof(bottom_left_three);i++){
        leds[bottom_left_three[i]] = CRGB::Black;
        FastLED.show();
        delay(100);}
     }
      else if (ll == 1){
        ...
        ll++;
        for (int i=0; i < sizeof(middle_paddle);i++){
          leds[middle_paddle[i]] = CRGB::Grey;
          FastLED.show();
          delay(100);}
        for (int i=0; i < sizeof(bottom_left_one);i++){
          leds[bottom_left_one[i]] = CRGB::Black;
        ...
        ll++;
        for (int i=0; i < sizeof(bottom_right_one);i++){
          leds[bottom_right_one[i]] = CRGB::Grey;
          FastLED.show();
          delay(100);}
        for (int i=0; i < sizeof(middle_paddle);i++){
          leds[middle_paddle[i]] = CRGB::Black;
        ...
        ll++;
        for (int i=0; i < sizeof(bottom_right_two);i++){
          leds[bottom_right_two[i]] = CRGB::Grey;
          FastLED.show();
          delay(100);
        }
        for (int i=0; i < sizeof(bottom_right_one);i++){
          leds[bottom_right_one[i]] = CRGB::Black;
          FastLED.show();
          delay(100);}
        } 
      else if (lr ==5){
        lr++;
        for (int i=0; i < sizeof(bottom_right_three);i++){
          leds[bottom_right_three[i]] = CRGB::Grey;
          FastLED.show();
          delay(100);
        }
       for (int i=0; i < sizeof(bottom_right_two);i++){
         leds[bottom_right_two[i]] = CRGB::Black;
         FastLED.show();
         delay(100);
        }
  }
       ...
       for (int i=0; i < sizeof(bottom_right_two);i++){
         ...
         delay(100);}
       for (int i=0; i < sizeof(bottom_right_three);i++){
        leds[bottom_right_three[i]] = CRGB::Black;
        FastLED.show();
        delay(100);}
  }
      else if (ll == 5){
